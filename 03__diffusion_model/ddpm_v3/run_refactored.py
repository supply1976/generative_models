...
class ConfigManager:
    ...
    def parse_config(config_path: str) -> Tuple[DatasetConfig, TrainingConfig, NetworkConfig, ImageGenConfig]:
        ...
        network_config = NetworkConfig(
            ...
            dropout_rate=network_dict.get('DROPOUT_RATE', 0.0),
...
class DiffusionTrainer:
    ...
    def train(self):
        ...
        # Setup callbacks
        callbacks = self._create_callbacks(logging_dir)
    ...
    def _create_callbacks(self, logging_dir: str) -> list:
        """Create training callbacks."""
        callbacks = [
            CSVLogger(os.path.join(logging_dir, "log.csv"), append=True, separator=","),
            keras.callbacks.LambdaCallback(
                on_epoch_end=lambda epoch, logs: None  # Placeholder for save_ema_model
            ),
            keras.callbacks.LambdaCallback(
