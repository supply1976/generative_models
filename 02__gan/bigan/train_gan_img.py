...
class MLModel(Model):
    ...
    def __init__(self,
        ...
        self.lambda_ratio = 100  # ratio of reconstrunction loss
    ...
    def compile(self, d_optimizer, g_optimizer, gan_loss_fn, rc_loss_fn):
    ...
    def g_loss(self, d_fake, fake_image, real_image):
        ...
        rc_loss = self.rc_loss_fn(real_image, fake_image)
        total_loss = gan_loss + (self.lambda_ratio * rc_loss)
        return total_loss, gan_loss, rc_loss
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as g_tape, tf.GradientTape() as d_tape:
            ...
            # Generator loss.
            g_loss, g_gan_loss, g_rc_loss = self.g_loss(d_fake, fake_image, real_image)
            # Discriminator loss.
...
class Trainer():
    ...
    def __init__(self,
        ...
        self.rc_loss_fn = get_loss_fn(generator_hyperparameters["LOSS"])   # rc_loss_fn : mae or mase
